...
_this addVest selectRandom ["rus_6b45_6sh117_machinegunner", "rus_6b45_machinegunner", "rus_6b45_machinegunner", "rus_6b45_machinegunner", "rus_6b45_machinegunner"];

_this addItemToVest "FirstAidKit";
for "_i" from 1 to 3 do {_this addItemToVest "rhs_100Rnd_762x54mmR";};
...
_this addWeapon selectRandom ["rhs_weap_pkp", "rhs_weap_pkm"];

_this addPrimaryWeaponItem selectRandom ["rhs_acc_1p78", "", "", "", "", "", "", "", ""];
