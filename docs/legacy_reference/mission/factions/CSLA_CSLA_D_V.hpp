...
CarE=[["CSLA_AZU","CSLAd"],["CSLA_AZU_para","CSLAd"],["CSLA_AZU_R2","CSLAd"]]; //car
CarDlcE=[]; //car apex dlc
CarArE=CarE; //armed car
CarArDlcE=[]; //armed car apex dlc
TruckE=[["CSLA_F813o","CSLAd"],["CSLA_F813","CSLAd"],["CSLA_V3So","CSLAd"],["CSLA_V3S","CSLAd"]]; //truck
ArmorE1=[["CSLA_BVP1","CSLAd"],["CSLA_BPzV","CSLAd"],["CSLA_OT62","CSLAd"],["CSLA_OT64C","CSLAd"],["CSLA_OT65A","CSLAd"]]; //apc, ifv
ArmorE2=[["CSLA_T72","CSLAd"],["CSLA_T72M","CSLAd"],["CSLA_T72M1","CSLAd"]]; //tank
ArmorDlcE2=[]; //tank tanks dlc

HeliTrE=[["CSLA_Mi17","desert"],["CSLA_Mi17mg","desert"]]; //transport heli
HeliTrDlcE=[]; //transport heli helicopters dlc
HeliArE = ["CSLA_Mi24V",["CSLA_Mi17pylons","desert"]]; //gunship (armed heli)

PlaneE=[]; //jet
PlaneDlcE=[]; //jets dlc

aaE=[["CSLA_PLdvK59V3S","CSLAd"]]; //Anti Air
artiE=[["CSLA_ShKH77","CSLAd"],["CSLA_RM51","CSLAd"]]; //artillery
