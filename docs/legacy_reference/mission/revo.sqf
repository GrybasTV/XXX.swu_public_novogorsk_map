...
[cursorTarget] execVM "revo.sqf";
[player] execVM "revo.sqf";
{[_x] execVM "revo.sqf";} foreach allunits;
...
private _role = getText (configfile >> "CfgVehicles" >> (typeOf _unit) >> "role");
