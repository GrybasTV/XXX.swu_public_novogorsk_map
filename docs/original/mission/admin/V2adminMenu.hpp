/*
	...
	Dependencies:
		admin scripts
		description.ext (#include "admin\V2adminMenu.hpp")
		defines.hpp
	...
	Execution:
		...
		On activation: aMenu = createDialog "V2adminMenu";
*/
class V2adminMenu
{
	idd = 2021;
	...
	class controls  // Main controls
	{
		...
		{
			idc = 503;
			text = "Zeus ON/OFF"; //--- ToDo: Localize;
			x = 14 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
			y = 5 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y;
			w = 12 * GUI_GRID_CENTER_W;
			h = 0.999999 * GUI_GRID_CENTER_H;
			tooltip = "Toggle Zeus"; //--- ToDo: Localize;
			action = "[] execVM ""admin\enableZeus.sqf"";";
		};
		class button3: RscButton
		{
			idc = 504;
			text = "Zeus units respawn ON/OFF"; //--- ToDo: Localize;
			x = 14 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
			y = 7 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y;
			w = 12 * GUI_GRID_CENTER_W;
			h = 0.999999 * GUI_GRID_CENTER_H;
			tooltip = "Toggle respawn of the units placed by ZEUS"; //--- ToDo: Localize;
