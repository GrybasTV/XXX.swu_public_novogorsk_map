...
CarW=["US85_M1008","US85_M1025_ua","US85_M1043_ua"]; //car
CarDlcW=[]; //car apex dlc
CarArW=["US85_M1025_M60","US85_M1025_M2","US85_M998SFGT","US85_M1043_M60"]; //armed car
CarArDlcW=[]; //armed car apex dlc
TruckW=["US85_M923o","US85_M923c","US85_M923a1o","US85_M923a1om2","US85_M923a1c","US85_M923a1cm2"]; //truck
ArmorW1=["US85_LAV25","US85_M113"]; //apc, ifv
ArmorW2=["US85_M1A1","US85_M1IP"]; //tank
ArmorDlcW2=[]; //tank tanks dlc

HeliTrW=["US85_MH60M134","US85_UH60","US85_UH60M240"]; //transport heli
HeliTrDlcW=[]; //transport heli helicopters dlc
HeliArW=["US85_AH1F","US85_MH60FFAR"]; //gunship (armed heli)
PlaneW=[]; //jet
PlaneDlcW=[]; //jets dlc

aaW=["US85_M163"]; //Anti Air
