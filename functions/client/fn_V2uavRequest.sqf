        ...
        call
        {
            if(_sde==sideW)exitWith
            {
                ...
                if (_usePerSquad) then {
                    ...
                    if(uavWr>0)exitWith
                    {
                        private _t=uavWr; private _s="sec"; if(uavWr>60)then{_t=floor (uavWr/60); _s="min";};
            ...
            if(_sde==sideE)exitWith
            {
                ...
                if (_usePerSquad) then {
                    ...
                    if(uavEr>0)exitWith
                    {
                        private _t=uavEr; private _s="sec"; if(uavEr>60)then{_t=floor (uavEr/60); _s="min";};
                        hint parseText format ["UAV service is unavailable<br/>UAV will be ready in %1 %2",_t,_s];
                    };
    ...
    if(_typ==1)exitWith
    {
        call
        {
            if(_sde==sideW)exitWith
            {
                ...
                if(ugvWr>0)exitWith
                {
                    private _t=ugvWr; private _s="sec"; if(ugvWr>60)then{_t=floor (ugvWr/60); _s="min";};
            ...
            if(_sde==sideE)exitWith
            {
                ...
                if(ugvEr>0)exitWith
                {
                    private _t=ugvEr; private _s="sec"; if(ugvEr>60)then{_t=floor (ugvEr/60); _s="min";};
                    hint parseText format ["UGV service is unavailable<br/>UGV will be ready in %1 %2",_t,_s];
                };
